...
EXTRA_PLUGINS = [
    {"internalName":"MovieBoxProvider","name":"MovieBoxProvider","description":"Multi Language Movies and Series Provider","authors":[],"tvTypes":["Movie","TvSeries"],"language":"id","status":1,"iconUrl":"https://github.com/NivinCNC/CNCVerse-Cloud-Stream-Extension/raw/refs/heads/master/MovieBoxProvider/icon.png"},
    {"internalName":"NgeFilm21Provider","name":"NgeFilm21Provider","description":"NgeFilm21 - Streaming Movie and TV Series","authors":[],"tvTypes":["AsianDrama","TvSeries","Movie"],"language":"id","status":1,"iconUrl":"https://new31.ngefilm.site/wp-content/uploads/2023/08/cropped-imageedit_8_4481000408-60x60.png"},
    {"internalName":"NontonAnimeIDProvider","name":"NontonAnimeIDProvider","description":"NontonAnimeID - Streaming Anime Subtitle Indonesia","authors":[],"tvTypes":["AnimeMovie","Anime","OVA"],"language":"id","status":1,"iconUrl":"https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://s11.nontonanimeid.boats&size=%size%"},
    {"internalName":"XSmoviebox","name":"XSmoviebox","description":"XSmoviebox","authors":[],"tvTypes":["AsianDrama","TvSeries","Movie"],"language":"id","status":1,"iconUrl":"https://moviebox.ph/favicon.ico"},
    {"internalName":"MovieOn21","name":"MovieOn21","description":"MovieOn21 provider","authors":[],"tvTypes":["Movie","TvSeries","AsianDrama"],"language":"id","status":1,"iconUrl":"https://www.google.com/s2/favicons?domain=tv.movieon21.mov&sz=%size%"},
    {"internalName":"Oppadrama","name":"Oppadrama","description":"Oppadrama provider","authors":[],"tvTypes":["AsianDrama","Movie","TvSeries"],"language":"id","status":1,"iconUrl":"https://www.google.com/s2/favicons?domain=oppadrama.co&sz=%size%"},
    {"internalName":"PencuriMovieProvider","name":"PencuriMovieProvider","description":"PencuriMovie provider","authors":[],"tvTypes":["Movie","Anime","Cartoon"],"language":"id","status":1,"iconUrl":"https://www.google.com/s2/favicons?domain=ww99.pencurimovie.bond&sz=%size%"},
    {"internalName":"Pusatfilm","name":"Pusatfilm","description":"Pusatfilm provider","authors":[],"tvTypes":["Movie","TvSeries"],"language":"id","status":1,"iconUrl":"https://www.google.com/s2/favicons?domain=pusatfilm.cam&sz=%size%"},
    {"internalName":"Samehadaku","name":"Samehadaku","description":"Samehadaku provider","authors":[],"tvTypes":["Anime","AnimeMovie","OVA"],"language":"id","status":1,"iconUrl":"https://www.google.com/s2/favicons?domain=samehadaku.email&sz=%size%"},
]
